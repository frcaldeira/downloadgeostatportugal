...
SOURCES = \
	__init__.py \
	downloadGeoStatPortugal.py downloadGeoStatPortugal_dialog.py

PLUGINNAME = downloadGeoStatPortugal

PY_FILES = \
	__init__.py \
	downloadGeoStatPortugal.py downloadGeoStatPortugal_dialog.py

UI_FILES = downloadGeoStatPortugal_dialog_base.ui
...
QGISDIR=C:\Users\francisco.caldeira\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
